...
class Medicine(models.Model):
    ...
    amount_per_day = models.CharField(verbose_name='Кол-во раз в день', max_length=20, help_text='Может содержать как число, так и описание: 2 таблетки в 3 дня' )
    ...
    def is_medicine_over(self) -> bool:
        ...
        medicine_datetime = datetime.datetime.combine(self.date, self.time)
        medicine_datetime = medicine_datetime.replace(tzinfo=current_timezone)
        return medicine_datetime < current_datetime